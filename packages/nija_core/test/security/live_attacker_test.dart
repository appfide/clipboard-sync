...
// NIJA_TEST_SUPABASE_URL / _ANON_KEY set (`dart test -t live`). Every
...
void main() {
  ...
  final url = env['NIJA_TEST_SUPABASE_URL'];
  final key = env['NIJA_TEST_SUPABASE_ANON_KEY'];
  if (url == null || key == null) {
    test(
      'live attacker (skipped: env not set)',
      () {},
      skip: 'set NIJA_TEST_SUPABASE_*',
    );
    return;
  }
