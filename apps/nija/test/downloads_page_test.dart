...
Map<String, Object?> _payload({String tag = 'v9.9.9'}) => {
  'tag_name': tag,
  'html_url': 'https://github.com/appfide/nija/releases/tag/$tag',
    ...
    for (final (name, size) in [
    ...
    ])
      {
        ...
        'browser_download_url':
            'https://github.com/appfide/nija/releases/download/$tag/$name',
      },
  ],
};
...
void main() {
  ...
  group('DownloadsPage', () {
    testWidgets('lists a section per platform with working rows', (
      ...
      expect(find.text('Nija 9.9.9'), findsOneWidget);
  ...
  group('ReleaseService', () {
    test('asks the API that belongs to the repo in BuildInfo', () {
      expect(
        ...
        'https://api.github.com/repos/appfide/nija/releases/latest',
      );
    });
