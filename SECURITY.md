...
[GitHub Security Advisories](https://github.com/appfide/nija/security/advisories/new).

You will receive an acknowledgement within 72 hours and a fix or mitigation plan within 14 days for confirmed issues.

## Threat model summary

- Nija talks **directly** to a database the user provisions. There is no Appfide server; Appfide never sees your data.
